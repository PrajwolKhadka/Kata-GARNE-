...
Ven = Tk()
Ven.title("HomePage")
Background = PhotoImage(file='Homepage.png')
...
det_rat1 = Label(Ven, text="Ratings", font=('Arial', 16), bg='#FCE9DC')
...
det_rat2 = Label(Ven, text="Ratings", font=('Arial', 16), bg='#FCE9DC')
...
det_rat3 = Label(Ven, text="Ratings", font=('Arial', 16), bg='#FCE9DC')

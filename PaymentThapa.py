            ...
            if c.fetchone():
                ...
                if c.fetchone():
                    ...
                    c.execute('INSERT INTO data(name, cont, venue, date, time) VALUES(?,?,?,?,?)',
                              (NameEnt.get(), ContEnt.get(), VenEnt.get(), DatEnt.get(), TimEnt.get()))
                    con.commit()
...
Pay_But = Button(Pay, text="Pay Now", font=("Helvetica", 20), bg='Green', command=add)
Pay_But.place(x=760, y=470)
